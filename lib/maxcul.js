...
class Maxcul extends events.EventEmitter {
    ...
    sendFakeTemperatureMessage(target, measuredTemp, desiredTemp){
        this.maxcul.sendTemperatureMessage(target, measuredTemp, desiredTemp, "00", this.maxcul.getDeviceId("WallMountedThermostat"));
    }
